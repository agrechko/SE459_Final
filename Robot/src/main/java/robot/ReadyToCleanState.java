...
{
	/**
	 * Checks the preconditions for successful clean cycle. If not met then the state becomes stop
	 */
	public void execute(RobotController robot) 
	{
		//if dirt capacity is <= 0 it means we do not have free space to put dirt
